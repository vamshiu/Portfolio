...
function About() {
  return (
        ...
        <div className=' h-screen  bg-black flex flex-col   items-center text-white my-10 pl-5 'name='about'>
            ...
            <div className='items-center flex flex-col sm:flex-row justify-evenly w-full  max-w-[1000px]  m-auto'>
                <div className=''>
